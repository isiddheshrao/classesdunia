	...
	<header class="">
		...
		<div class="page-heading listing-page">
			<div class="page-heading-inner-container text-center">
				<h1>Get Your Best Coupon Here</h1>
				<ul class="breadcrumbs">
					<li><a href="index.html">Signup For Few More Subjects</a></li>
					<!--<li><span>Submit Your Listing</span></li>-->
				</ul>
			</div>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-0">
					<div class="form-page-heading">
						<h3>Input a Sub Stream</h3>
						<p>Input as much as correct info you can!</p>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<div class="lp-border-radius-8 lp-border lp-form-container">
						<div class="lp-form-row clearfix lp-border-bottom margin-bottom-40 padding-bottom-40">
							<div class="lp-form-row-right text-right pull-right  margin-top-35">
								<a href="#" class="btn-first-hover lp-signout-btn">Add More</a>
							</div>
						</div>

						<form id="substream_form">

							<div class="form-group">
								<label for="substream_name">Sub-Stream Name</label>
								<input type="text" class="form-control" name="substream_name" id="substream_name" placeholder="Sub Stream Name" required>
							</div>

							<div class="form-group">

								<label for="mainstream">Please Select field Name</label>
								  <select placeholder="Choose a Stream" name="mainstream" class="cd-dropdown" size="4" required>
							...
							<div class="form-group">
								<input type="submit" value="Save this stream" class="lp-secondary-btn btn-first-hover" />
							</div>
