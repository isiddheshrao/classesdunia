					...
					<div class="row">
							...
							<div class="lp-search-bar">
								<form method="POST" action="listing.php" >
									...
									<div class="search-div">
									  <select class="search-select" id="search-location" name="location">
	                    ...
	                    require 'helper.php';
	                            ...
	                            echo '<option value="'.$row['loc'].'">'.$row['loc'].'</option>';
									...
									<div class="search-div">
									  <select class="search-select" id="search-stream" name="stream">
										<option value="">Select one...</option>
	                            ...
	                            echo '<option value="'.$row['ssname'].'">'.$row['ssname'].'</option>';
									...
									<div class="search-div">
									  <select class="search-select" id="search-subject" name="subject">
										<option value="">Select one...</option>
