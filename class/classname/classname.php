...
<head>
	...
	<!-- Title -->
	<title>ClassesDunia - Demo Class</title>
				...
				<div class="row">
					<div class="">
						<div class="post-slide">
							<div class="slide">
								<img src="http://via.placeholder.com/580x200"/>
							</div>
							<div class="slide">
								<img src="http://via.placeholder.com/580x200"/>
							</div>
				...
				<div class="col-md-8">
					<div class="post-row">
						<ul class="list-style-none post-price-row line-height-16">
							<li><span class="post-rice">About Class</span></li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<td>
									<div class="form-group">
										<button type="button" class="btn btn-primary" onclick="shortlist('class name,7 AM-1 PM (3 Days a Week),Rs.12000/-,1000/-')">checklist</button>
									</div>
								</td>
								</tr>
								<tr>
