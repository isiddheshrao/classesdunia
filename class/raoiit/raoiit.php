...
<head>
	...
	<!-- Title -->
	<title>ClassesDunia - Rao IIT</title>
				...
				<div class="col-md-8">
					<div class="post-row">
						<ul class="list-style-none post-price-row line-height-16">
							<li><span class="post-rice">About  Rao IIT Academy</span></li>
...
<!-- Project Details Go Here -->
								...
								<td>	
									<div class="form-group">
										<button type="button" class="btn btn-primary" onclick="shortlist('raoiit,7 AM-1 PM (3 Days a Week),Rs.12000/-,1000/-')">checklist</button>
									</div>
								</td>
								</tr>
								<tr>
