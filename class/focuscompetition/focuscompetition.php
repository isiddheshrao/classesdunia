...
<head>
	...
	<!-- Title -->
	<title>ClassesDunia - Focus Competition Zone</title>
					...
					<div class="col-md-8">
						<div class="post-meta-left-box">
							<ul class="breadcrumbs">
								...
								<li><a href="../../listing-entrance.html">Entrance</a></li>
								<li><span>Government Jobs</span></li>
							</ul>
							<h1>Focus Competition Zone</h1>
							<ul class="post-stat">
								<li>
				...
				<div class="col-md-8">
					<div class="post-row">
						<ul class="list-style-none post-price-row line-height-16">
							<li><span class="post-rice">About Focus Competition Zone</span></li>
							
						</ul>
					</div>
					<div class="post-row padding-top-40">
						<p>
							Focus competition zone is a zone which renders a strong foundation to all the aspirants preparing for the exams like BANK, STAFF SELECTION,INSURANCE, RAILWAY and other competitive exams of same level. We impart comprehensive training-cum guidance program up to the final selection.
						</p>
						<p>
							 The pillars of our institute are the virtuoso faculties who are unmatched in their respective subject. We believe not only in teaching but in selection which is our ultimate goal. For this it needs firm assistance regarding short-tricks, right approach, time-management and other pros and cons of the exam. We inculcate all these qualities in the aspirants with such an ease that they feel hand and glove at the time of examination. Our research and development (R&D) team is busy 24X7 making sample questions for study material and speed tests according to the upcoming exam pattern. These questions make students learn the subject from the basic level to the excellence. We keep a keen observation in giving the answers to these questions and hardly make any mistake which is our U.S.P. and it helps our students to perform up to the mark in the examination.
						</p>
						<p>Today is the era of cut-throat competition and getting success among lacks of candidates is an uphill-task. So our modus-operandi is to emphasize a lot on logic which make others to be in the waterloo. Our previous student who has created a benchmark and has come up with flying colors in various competitive exams and has brought laurel to our institution stand a testimony to focuses stunning performance and made worth of focus competition zone punch line<br><b>“A strong foundation for all government jobs.”<b>
						</p>
					</div>
						...
						<ul class="lp-teaching-categoires">
							...
							<a href="#portfolioModal3" class="portfolio-link lp-border-radius-5" data-toggle="modal">
								<span class="tick-icon">
									...
									<img class="icon icons8-Checked" src="data:image/png;base64," alt="checked">
								<br>
								Specialist Officer <br> Book Now
								</span>
								</a>
							</li><br>
							<li>
							...
							<div class="comments-box">
								...
								<div class="comments-content">
									...
									<div class="comments-description">
										<p>
											Focus Institute having good faculty with experience. Teachers are very helpful, because of Focus I have got selected for interviews. THANK YOU FOCUS TEAM
										</p>
									</div>
								</div>
							</div><!--../comments-box-->
								...
								<div class="comments-content">
									<div class="comments-meta-box">
										<div class="comments-author text-left">
											...
											<div class="comments-date">
												Income Tax Department- Ex-Student 
												<div class="post-reviews">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
									...
									<div class="comments-description">
										<p>
											This is the best classes I joined ever. All are experienced faculty with good knowledge in mathematics which is tough in class. Thanks to Focus Competition Zone !!!
										</p>
									</div>
								</div>
							</div><!--../comments-box-->
					...
					<div class="sidebar-post">
						<div class="widget-box  widget-bg-color post-author-box lp-border-radius-5">
							<div class="user-info">
								...
								<div class="user-text">
									<h5 class="user-name margin-top-0"><a href="#">Focus Competition</a></h5>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<td>	
									<div class="form-group">
										<button type="button" class="btn btn-primary" onclick="shortlist('focus competition,7 AM-1 PM (3 Days a Week),Rs.12000/-,1000/-')">checklist</button>
									</div>
								</td>
								</tr>
								<tr>
