...
<head>
	...
	<!-- Title -->
	<title>ClassesDunia - Progate Coaching</title>
				...
				<div class="col-md-8">
					<div class="post-row">
						<ul class="list-style-none post-price-row line-height-16">
							<li><span class="post-rice">About Progate</span></li>
					...
					<div class="post-row padding-top-40">
						<p>
							<ul>
								<li>300+ IIT / IISc alumni have come together to create ProGATE Coaching by IITians and GATE Toppers.</li>
							<li>Content library of the best study material, video lectures, test series created by top IIT/IISc GATE Toppers.</li>
							<li>Study Material in all 20 GATE branches.</li>
							<li>Video Lectures of 2000+ hours covering the GATE syllabus.</li>
							<li>Question Database of 400000+ questions.</li>
							<li>Assessment platform created by ex-E-bay and IITian firm based in San Francisco.</li>
							<li>E-copies of additional material required for cracking the GATE exam.</li>
							<li>Infrastructure to hold remote classes anywhere in the country through video lectures from our HQ.</li>
							<li>For offline classes, we provide USB GATE Drive (Video Lectures on USB pendrive) which can be used to conduct group video lectures at any venue in India.</li>
							<li>Huge faculty database in all IIT/IISc/NITs and top engineering colleges in India.</li>
							<li>ProGATE Coaching aims to be the pioneer in providing the next generation courses for GATE and other allied technical subjects that help students reach their potential and excel.</li>
						</ul>
						</p>
					</div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<td>	
									<div class="form-group">
										<button type="button" class="btn btn-primary" onclick="shortlist('progate,7 AM-1 PM (3 Days a Week),Rs.12000/-,1000/-')">checklist</button>
									</div>
								</td>
								</tr>
								<tr>
