      ...
      <div id="footer-wrapper">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-2">
            ...
            <ul>
        <li><a href="/work/index.php"><i class="fa fa-home fa-fw"></i> Home</a></li>
      <li><a href="/work/privacypolicy.php"><i class="fa fa-link"></i>   Privacy Policy</a></li>
      <li><a href="/work/contact-us.php"><i class="fa fa-envelope fa-fw"></i> Contact Us</a></li>
           </ul>
</div>      </div> <!-- end widget1 -->
          ...
          <div class="col-sm-6 col-md-4">
           ...
           <div class="col-sm-6 col-md-2">
                <div id="recent-posts-3" class="widget widgetFooter widget_recent_entries">
                  ...
                  <ul>
        <li>
           <a href="#" target="#"><img src="/work/images/payment/visa.png"></a>
           <a href="#" target="#"><img src="/work/images/payment/mastercard.png"></a>
       </li>
       <li>
           <a href="#" target="#"><img src="/work/images/payment/bhim.png"></a>
           <a href="#" target="#"><img src="/work/images/payment/instamojo.png"></a>
         </li>
      </ul>
  </div>
        </div> <!-- end .row -->
